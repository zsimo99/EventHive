...
function page() {
  return (
    <div className="mx-auto min-h-screen bg-linear-to-b from-indigo-700 to-fuchsia-600  text-white">
      <div className="container mx-auto px-3 pt-48 flex items-center gap-16 h-full">
        <div className="flex-1 h-full md:ps-10">
          ...
          <h1 className="text-3xl md:text-[43px] xl:text-6xl text-center lg:text-start mb-8 text-shadow-lg font-semibold leading-tight">
            Find Your Next <br className="max-lg:hidden" />
            Unforgettable Event
          </h1>
          <p className="text-sm md:text-xl text-center lg:text-start font-thin">
            Connect with concerts, workshops, and conferences that inspire you.
            Book instantly and manage everything in one place.
          </p>
          <div className="max-lg:px-10 my-4">
            <HeroSearch />
          </div>
          <HeroStats />
        </div>
        <div className="flex-1 h-full max-lg:hidden flex flex-wrap gap-4">
          <HeroCard
